...
- **Anthropic hits $47B annualized revenue.** President Daniela Amodei said at Bloomberg Tech that run-rate revenue reached $47B in May, up from ~$9B at end of 2025. Signals how fast enterprise AI spend is scaling.
- **Apple opens Siri to multiple AI models at WWDC.** A new Extensions system makes Claude selectable on iPhone for the first time, alongside a Gemini-powered Siri. Big distribution shift for model makers.
- **Google's Gemini 3.5 Pro still pending public release.** Announced at I/O on May 19; as of today it has not shipped publicly. Worth watching for a June drop.
- **Agents move into real work across the big labs.** Google, OpenAI, and Anthropic are all pushing toward managed, self-improving task flows rather than single prompts. The "agent that does the job" race is on.
